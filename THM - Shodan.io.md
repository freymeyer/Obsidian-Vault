...
> **Room Link:** https://tryhackme.com/room/shodan
...
- [x] [[Autonomous System Number (ASN)]] - Global identifier for IP address ranges owned by organizations
- [x] [[Banner Grabbing]] - Extracting service information from network banners
- [x] [[Shodan Dorking]] - Using advanced filters on Shodan to find vulnerable systems
- [x] [[Heartbleed]] - CVE-2014-0160, critical OpenSSL vulnerability
- [x] [[Favicon Hash]] - Fingerprinting web apps via favicon MurmurHash3 

## 📝 Lab Journal
*Chronological log of actions, commands, and findings.*

### Task 1: Introduction
Read the [blog post](https://skerritt.blog/shodan) for a more in-depth explanation. Room created by [BeeSec](https://twitter.com/bee_sec_san)
...
## 🚩 Flags
| Task | Question                                                                                                                  | Flag                                      | Searches                                       |
| ---- | ------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- | ---------------------------------------------- |
| 1    | Go to Shodan.io                                                                                                           | `No answer needed`                        |                                                |
| 2    | What command is used to find Eternal Blue exploits on Shodan using the **vuln** filter?                                   | `vuln:ms17-010`                           |                                                |
| 3    | What is the top operating system for MYSQL servers in Google's ASN?                                                       | `5.6.40-84.0-log`                         | `"asn:AS15169 product:"MySQL"`                 |
| 3    | What is the 2nd most popular country for MYSQL servers in Google's ASN?                                                   | `Netherlands`                             | `"asn:AS15169 product:"MySQL"`                 |
| 3    | Under Google's ASN, which is more popular for nginx, Hypertext Transfer Protocol or Hypertext Transfer Protocol with SSL? | `Hypertext Transfer Protocol`             | `"asn:AS15169 product:"nginx"`                 |
| 3    | Under Google's ASN, what is the most popular city?                                                                        | `Kansas City`                             | `"asn:AS15169 country:"US"`                    |
| 3    | Under Google's ASN in Los Angeles, what is the top operating system according to Shodan?                                  | `Debian`                                  | `"asn:AS15169 country:"US" city:"Los Angeles"` |
| 3    | Using the top Webcam search from the explore page, does Google's ASN have any webcams? Yay / nay.                         | `Nay`                                     |                                                |
| 4    | What URL takes you to Shodan Monitor?                                                                                     | `https://monitor.shodan.io/dashboard`     |                                                |
| 5    | What dork lets us find PCs infected by Ransomware?                                                                        | `has_screenshot:true encrypted attention` |                                                |
| 6    | This will be nice for bug bounties!                                                                                       | `No answer needed`                        |                                                |
| 7    | Read the blog post above!                                                                                                 | `No answer needed`                        |                                                |
