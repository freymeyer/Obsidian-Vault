...
*Concepts extracted and notes created:*
- [x] [[Ping]] - ICMP-based connectivity test
- [x] [[ICMP]] - Internet Control Message Protocol for diagnostics
- [x] [[Traceroute]] - Maps network path via TTL expiration
- [x] [[TTL (Time To Live)]] - Hop limit in IP packets
- [x] [[Telnet]] - Legacy cleartext remote access protocol
- [x] [[Netcat (nc)]] - Swiss Army knife networking tool
- [x] [[Banner Grabbing]] - Service version enumeration technique
...
On your AttackBox terminal, you can start to use ping as `ping 10.48.171.31` or `ping HOSTNAME`. In the latter, the system needs to resolve HOSTNAME to an IP address before sending the ping packet. If you don’t specify the count on a Linux system, you will need to hit `CTRL+c` to force it to stop. Hence, you might consider `ping -c 10 10.48.171.31` if you just want to send ten packets. This is equivalent to `ping -n 10 10.48.171.31` on a MS Windows system.
...
In the following example, we have specified the total count of packets to 5. From the AttackBox’s terminal, we started pinging `10.48.171.31`. We learned that `10.48.171.31` is up and is not blocking ICMP echo requests. Moreover, any firewalls and routers on the packet route are not blocking ICMP echo requests either.

AttackBox Terminal

           `user@AttackBox$ ping -c 5 10.48.171.31 PING 10.48.171.31 (10.48.171.31) 56(84) bytes of data. 64 bytes from 10.48.171.31: icmp_seq=1 ttl=64 time=0.636 ms 64 bytes from 10.48.171.31: icmp_seq=2 ttl=64 time=0.483 ms 64 bytes from 10.48.171.31: icmp_seq=3 ttl=64 time=0.396 ms 64 bytes from 10.48.171.31: icmp_seq=4 ttl=64 time=0.416 ms 64 bytes from 10.48.171.31: icmp_seq=5 ttl=64 time=0.445 ms  --- 10.48.171.31 ping statistics --- 5 packets transmitted, 5 received, 0% packet loss, time 4097ms rtt min/avg/max/mdev = 0.396/0.475/0.636/0.086 ms`
...
On Linux and macOS, the command to use is `traceroute 10.48.171.31`, and on MS Windows, it is `tracert 10.48.171.31`. `traceroute` tries to discover the routers across the path from your system to the target system.
...
AttackBox Terminal - Traceroute A
           ...
           `user@AttackBox$ traceroute tryhackme.com traceroute to tryhackme.com (172.67.69.208), 30 hops max, 60 byte packets  1  ec2-3-248-240-5.eu-west-1.compute.amazonaws.com (3.248.240.5)  2.663 ms * ec2-3-248-240-13.eu-west-1.compute.amazonaws.com (3.248.240.13)  7.468 ms  2  100.66.8.86 (100.66.8.86)  43.231 ms 100.65.21.64 (100.65.21.64)  18.886 ms 100.65.22.160 (100.65.22.160)  14.556 ms  3  * 100.66.16.176 (100.66.16.176)  8.006 ms *  4  100.66.11.34 (100.66.11.34)  17.401 ms 100.66.10.14 (100.66.10.14)  23.614 ms 100.66.19.236 (100.66.19.236)  17.524 ms  5  100.66.7.35 (100.66.7.35)  12.808 ms 100.66.6.109 (100.66.6.109)  14.791 ms *  6  100.65.14.131 (100.65.14.131)  1.026 ms 100.66.5.189 (100.66.5.189)  19.246 ms 100.66.5.243 (100.66.5.243)  19.805 ms  7  100.65.13.143 (100.65.13.143)  14.254 ms 100.95.18.131 (100.95.18.131)  0.944 ms 100.95.18.129 (100.95.18.129)  0.778 ms  8  100.95.2.143 (100.95.2.143)  0.680 ms 100.100.4.46 (100.100.4.46)  1.392 ms 100.95.18.143 (100.95.18.143)  0.878 ms  9  100.100.20.76 
222.241.87)  16.543 ms 16  100.92.228.102 (100.92.228.102)  15.168 ms 100.92.227.41 (100.92.227.41)  10.134 ms 100.92.227.52 (100.92.227.52)  11.756 ms 17  100.92.232.111 (100.92.232.111)  10.589 ms 100.92.231.69 (100.92.231.69)  16.664 ms 100.92.232.37 (100.92.232.37)  13.089 ms 18  100.91.205.140 (100.91.205.140)  11.551 ms 100.91.201.62 (100.91.201.62)  10.246 ms 100.91.201.36 (100.91.201.36)  11.368 ms 19  100.91.205.79 (100.91.205.79)  11.112 ms 100.91.205.83 (100.91.205.83)  11.040 ms 100.91.205.33 (100.91.205.33)  10.114 ms 20  100.91.211.45 (100.91.211.45)  9.486 ms 100.91.211.79 (100.91.211.79)  13.693 ms 100.91.211.47 (100.91.211.47)  13.619 ms 21  100.100.6.81 (100.100.6.81)  11.522 ms 100.100.68.70 (100.100.68.70)  10.181 ms 100.100.6.21 (100.100.6.21)  11.687 ms 22  100.100.65.131 (100.100.65.131)  10.371 ms 100.100.92.6 (100.100.92.6)  10.939 ms 100.100.65.70 (100.100.65.70)  23.703 ms 23  100.100.2.74 (100.100.2.74)  15.317 ms 100.100.66.17 (100.100.66.17)  11.492 ms 100.100.88.67 (100.100.88.67)  35.312 ms 24  100.100.16.16 (100.100.16.16)  19.155 ms 100.100.16.28 (100.100.16.28)  19.147 ms 100.100.2.68 (100.100.2.68)  13.718 ms 25  99.83.89.19 (99.83.89.19)  28.929 ms *  21.790 ms 26  104.26.11.229 (104.26.11.229)  11.070 ms  11.058 ms  11.982 ms`
...
However, the telnet client, with its simplicity, can be used for other purposes. Knowing that telnet client relies on the TCP protocol, you can use Telnet to connect to any service and grab its banner. Using `telnet 10.48.171.31 PORT`, you can connect to any service running on TCP and even exchange a few messages unless it uses encryption.
...
Pentester Terminal
           ...
           `pentester@TryHackMe$ telnet 10.48.171.31 80 Trying 10.48.171.31... Connected to 10.48.171.31. Escape character is '^]'. GET / HTTP/1.1 host: telnet  HTTP/1.1 200 OK Server: nginx/1.6.2 Date: Tue, 17 Aug 2021 11:13:25 GMT Content-Type: text/html Content-Length: 867 Last-Modified: Tue, 17 Aug 2021 11:12:16 GMT Connection: keep-alive ETag: "611b9990-363" Accept-Ranges: bytes    ...`
...
First, you can connect to a server, as you did with Telnet, to collect its banner using `nc 10.48.171.31 PORT`, which is quite similar to our previous `telnet 10.48.171.31 PORT`. Note that you might need to press SHIFT+ENTER after the GET line.

Pentester Terminal

           `pentester@TryHackMe$ nc 10.48.171.31 80 GET / HTTP/1.1 host: netcat  HTTP/1.1 200 OK Server: nginx/1.6.2 Date: Tue, 17 Aug 2021 11:39:49 GMT Content-Type: text/html Content-Length: 867 Last-Modified: Tue, 17 Aug 2021 11:12:16 GMT Connection: keep-alive ETag: "611b9990-363" Accept-Ranges: bytes ...`
        

In the terminal shown above, we used netcat to connect to 10.48.171.31 port 80 using `nc 10.48.171.31 80`. Next, we issued a get for the default page using `GET / HTTP/1.1`; we are specifying to the target server that our client supports HTTP version 1.1. Finally, we need to give a name to our host, so we added on a new line, `host: netcat`; you can name your host anything as this has no impact on this exercise.
...
On the _client_-side, you would issue `nc 10.48.171.31 PORT_NUMBER`. Here is an example of using `nc` to echo. After you successfully establish a connection to the server, whatever you type on the client-side will be echoed on the server-side and vice versa.

Consider the following example. On the server-side, we will listen on port 1234. We can achieve this with the command `nc -vnlp 1234` (same as `nc -lvnp 1234`). In our case, the listening server has the IP address `10.48.171.31`, so we can connect to it from the client-side by executing `nc 10.48.171.31 1234`. This setup would echo whatever you type on one side to the other side of the TCP tunnel. You can find a recording of the process below. Note that the listening server is on the left side of the screen.
### Task 7: Putting It All Together

## 🚩 Flags
| Task | Question                                                                                                                                                                                                                                                                      | Flag               |
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| 1    | Ensure that you understand why these tools fall under active reconnaissance. Launch your AttackBox and ensure that it is ready. You will need it to answer the questions, especially in later tasks.                                                                          | `No answer needed` |
| 2    | Browse to the [following website](https://static-labs.tryhackme.cloud/sites/networking-tcp/) and ensure that you have opened your Developer Tools on AttackBox Firefox, or the browser on your computer. Using the Developer Tools, figure out the total number of questions. | `8`                |
| 3    | Which option would you use to set the size of the data carried by the ICMP echo request?                                                                                                                                                                                      | -s                 |
| 3    | What is the size of the ICMP header in bytes?                                                                                                                                                                                                                                 | 8                  |
| 3    | Does MS Windows Firewall block ping by default? (Y/N)                                                                                                                                                                                                                         | Y                  |
| 3    | Deploy the VM for this task and using the AttackBox terminal, issue the command `ping -c 10 10.48.171.31`. How many ping replies did you get back?                                                                                                                            | 10                 |
| 4    | In Traceroute A, what is the IP address of the last router/hop before reaching tryhackme.com?                                                                                                                                                                                 | `172.67.69.208`    |
| 4    | In Traceroute B, what is the IP address of the last router/hop before reaching tryhackme.com?                                                                                                                                                                                 | `104.26.11.229`    |
| 4    | In Traceroute B, how many routers are between the two systems?                                                                                                                                                                                                                | `26`               |
| 4    | Start the attached VM from Task 3 if it is not already started. On the AttackBox, run `traceroute 10.48.171.31`. Check how many routers/hops are there between the AttackBox and the target VM.                                                                               | `No answer needed` |
| 5    | Start the attached VM from Task 3 if it is not already started. On the AttackBox, open the terminal and use the telnet client to connect to the VM on port 80. What is the name of the running server?                                                                        | `Apache`           |
| 5    | What is the version of the running server (on port 80 of the VM)?                                                                                                                                                                                                             | `2.4.61`           |
| 6    | Start the VM and open the AttackBox. Once the AttackBox loads, use Netcat to connect to the VM port 21. What is the version of the running server?                                                                                                                            | `0.17`             |
| 7    | Ensure that you gain mastery over the different basic yet essential tools we presented in this room before moving on to more sophisticated tools.                                                                                                                             | `No answer needed` |

## 🎓 Key Takeaways
- [[Active Reconnaissance]] requires direct interaction with targets—always get authorization first
- [[Ping]] uses [[ICMP]] Echo Request/Reply to verify hosts are online (but may be blocked by firewalls)
- [[Traceroute]] exploits [[TTL (Time To Live)]] expiration to map network hops between you and a target
- [[Telnet]] is insecure (cleartext) but useful for manual [[Banner Grabbing]] on any TCP port
- [[Netcat (nc)]] is the "Swiss Army knife"—supports TCP/UDP client/server, banner grabbing, file transfers, and shells
- [[Banner Grabbing]] reveals service versions (e.g., `Apache/2.4.61`, `vsFTPd 0.17`) for vulnerability research
- Windows Firewall blocks [[ICMP]] by default—don't assume a host is down if ping fails
- Developer Tools in browsers can reveal hidden page structure, cookies, and technology stacks during web recon
