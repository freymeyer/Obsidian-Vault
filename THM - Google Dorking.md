...
- [x] [[Google Dorking]] - Advanced search operators for OSINT
- [x] [[Web Crawler]] - Search engine bots that index web content
- [x] [[robots.txt]] - File that tells crawlers what to index/skip
- [x] [[Search Engine Optimization (SEO)]] - Improving search rankings
- [x] [[Sitemap]] - XML file listing site URLs for crawlers
...
### Task 2: Let's Learn About [[Web Crawler|Crawlers]]
...
![](https://assets.tryhackme.com/additional/imgur/4nrDDa0.png)
...
![](https://assets.tryhackme.com/additional/imgur/nbbsAp4.png)
...
![](https://assets.tryhackme.com/additional/imgur/CIM2c6N.png)
...
![](https://assets.tryhackme.com/additional/imgur/BJeI451.png)  
...
![](https://assets.tryhackme.com/additional/imgur/lBD6FPD.png)  
...
![](https://assets.tryhackme.com/additional/imgur/1LGoslC.png)  
...
![](https://assets.tryhackme.com/additional/imgur/OG2Fgsx.png)
...
### Task 3: Enter: [[Search Engine Optimization (SEO)|Search Engine Optimisation]]
...
![](https://assets.tryhackme.com/additional/imgur/kvaFolh.png)  

  

![](https://assets.tryhackme.com/additional/imgur/6rFnpVc.png)  
...
![](https://assets.tryhackme.com/additional/imgur/wZ3lo4B.png)  
...
![](https://assets.tryhackme.com/additional/imgur/audlFn8.png)
...
![](https://assets.tryhackme.com/additional/imgur/LxitBJs.png)
...
![](https://assets.tryhackme.com/additional/imgur/mzDqFVY.png)
...
![](https://assets.tryhackme.com/additional/imgur/L5WqJU4.png)
...
![](https://assets.tryhackme.com/additional/imgur/12Yxcn5.png)
...
![](https://assets.tryhackme.com/additional/imgur/hrfWM6i.png)  
...
![](https://assets.tryhackme.com/additional/imgur/pJSW4ou.png)  
...
![](https://assets.tryhackme.com/additional/imgur/b4duG6S.png)  
...
![](https://assets.tryhackme.com/additional/imgur/dG3e64O.png)  
...
![](https://assets.tryhackme.com/additional/imgur/xoDtXnA.png)
...
![](https://assets.tryhackme.com/additional/imgur/24OH1Kk.png)
...
![](https://assets.tryhackme.com/additional/imgur/o0Cnm1P.png)

## 🚩 Flags
| Task | Question                                                                                                                                                                                                                                                 | Flag                             |
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| 1    | Roger dodger!                                                                                                                                                                                                                                            | `No answer needed`               |
| 2    | Name the key term of what a "Crawler" is used to do. This is known as a collection of resources and their locations                                                                                                                                      | `Index`                          |
| 2    | What is the name of the technique that "Search Engines" use to retrieve this information about websites?                                                                                                                                                 | `Crawling`                       |
| 2    | What is an example of the type of contents that could be gathered from a website?                                                                                                                                                                        | `Keywords`                       |
| 3    | Use the same [SEO checkup tool](https://web.dev/measure/) and other online alternatives to see how their results compare for [https://tryhackme.com](https://tryhackme.com) and [http://googledorking.cmnatic.co.uk](http://googledorking.cmnatic.co.uk) | `No answer needed`               |
| 4    | Where would "robots.txt" be located on the domain "**ablog.com**"                                                                                                                                                                                        | `ablog.com/robots.txt`           |
| 4    | If a website was to have a sitemap, where would that be located?                                                                                                                                                                                         | `/sitemap.xml`                   |
| 4    | How would we only allow "Bingbot" to index the website?                                                                                                                                                                                                  | `User-agent: Bingbot`            |
| 4    | How would we prevent a "Crawler" from indexing the directory "/dont-index-me/"?                                                                                                                                                                          | `Disallow: /dont-index-me/`      |
| 4    | What is the extension of a Unix/Linux system configuration file that we might want to hide from "Crawlers"?                                                                                                                                              | `.conf`                          |
| 5    | What is the typical file structure of a "Sitemap"?                                                                                                                                                                                                       | `XML`                            |
| 5    | What real life example can "Sitemaps" be compared to?                                                                                                                                                                                                    | `Map`                            |
| 5    | Name the keyword for the path taken for content on a website                                                                                                                                                                                             | `Route`                          |
| 6    | What would be the format used to query the site bbc.co.uk about flood defences                                                                                                                                                                           | `site: bbc.co.uk flood defences` |
| 6    | What term would you use to search by file type?                                                                                                                                                                                                          | `filetype:`                      |
| 6    | What term can we use to look for login pages?                                                                                                                                                                                                            | `intitle: login`                 |

## 🎓 Key Takeaways
- [[Web Crawler|Crawlers]] discover and index web content by following links recursively
- [[robots.txt]] suggests what crawlers should/shouldn't index—but it's NOT security
- [[Search Engine Optimization (SEO)|SEO]] ranking depends on keywords, responsiveness, crawlability, and [[Sitemap|sitemaps]]
- [[Google Dorking]] uses advanced search operators (`site:`, `filetype:`, `intitle:`) to find sensitive info
- Listing sensitive paths in robots.txt creates a roadmap for attackers
