...
- Processing large amounts of data - Analysing big data from multiple types of sources like system and network logs
- Behaviour analysis - Tracking normal behaviour and activities and then flagging anything that's abnormal
- Generative AI - Summarising context behind a series of events
