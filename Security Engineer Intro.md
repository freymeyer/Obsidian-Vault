...
- [x] [[Asset Inventory]] - Managing and maintaining digital asset catalog
- [x] [[Secure by Design]] - Security-first architecture philosophy
- [x] [[Tabletop Exercise]] - Theoretical IR readiness assessment
- [x] [[Purple Teaming]] - Collaborative red/blue team testing
- [x] [[Governance, Risk and Compliance (GRC)]] - Security governance framework 
...
| Task | Question                                                                                                                                                    | Flag                           |
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| 1    | I have reviewed the learning objectives.                                                                                                                    | `No answer needed`             |
| 2    | Who ensures that an organization's cyber security risk is minimized at all times?                                                                           | `Security engineer`            |
| 3    | Where are details about an organization's digital assets, such as name, IP address, and owner, stored?                                                      | `Asset inventory`              |
| 3    | Sometimes security policies can't be followed because of business needs. What avenue does a security engineer have to fulfil business needs in these cases? | `Exceptions`                   |
| 3    | What philosophy, if followed, provides the most Return on Investment (ROI)?                                                                                 | `Secure by design`             |
| 4    | What is considered the weakest link in an organization's security?                                                                                          | `humans`                       |
| 4    | An organization's security evolves with the organization. What helps a security engineer keep the organization secure through these changes?                | `Change management`            |
| 5    | What is a theoretical exercise carried out to gauge the operational readiness of an organization from a security point of view?                             | `Tabletop exercise`            |
| 5    | What is the priority of the management in case of a disaster or crisis?                                                                                     | `Business Continuity`          |
| 6    | What is the flag shown on the completion of the static site?                                                                                                | `THM{S3CUR1TY_3NG1N33R5_R0CK}` |
| 7    | Head over to our social channels for further discussion.                                                                                                    | `No answer needed`             |
