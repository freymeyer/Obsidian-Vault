...
dg-publish: true
tags:
  - "#cybersecurity/incident-response/tooling"
aliases:
...
## 🔬 How It Works
### Core Principles
1. Standardised contents tailored to org environment.
2. Periodic audits and refresh (media, software versions).
3. Secure, controlled storage and access.
...
- It’s just software — physical tools and documentation matter equally.
