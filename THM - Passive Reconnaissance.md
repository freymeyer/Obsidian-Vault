...
> **Room Link:** https://tryhackme.com/room/passiverecon

## 🧠 Knowledge Inbox (Unfamiliar Things)
*Concepts extracted and linked to vault notes.*
- [x] [[Passive Reconnaissance]] - Gathering info without touching target systems
- [x] [[Active Reconnaissance]] - Direct interaction with target (detectable)
- [x] [[WHOIS]] - Protocol for querying domain registration info (TCP 43)
- [x] [[nslookup]] - CLI tool for DNS queries
- [x] [[Domain Information Groper (dig)]] - Advanced DNS query tool
- [x] [[DNSDumpster]] - Online subdomain discovery tool
- [x] [[Shodan]] - Search engine for internet-connected devices
...
![](https://tryhackme-images.s3.amazonaws.com/user-uploads/5f04259cf9bf5b57aed2c476/room-content/dbda3c79cc81408315a218749030256a.png)
...
Terminal
           ...
           `user@TryHackMe$ whois tryhackme.com [Querying whois.verisign-grs.com] [Redirected to whois.namecheap.com] [Querying whois.namecheap.com] [whois.namecheap.com] Domain name: tryhackme.com Registry Domain ID: 2282723194_DOMAIN_COM-VRSN Registrar WHOIS Server: whois.namecheap.com Registrar URL: http://www.namecheap.com Updated Date: 2021-05-01T19:43:23.31Z Creation Date: 2018-07-05T19:46:15.00Z Registrar Registration Expiration Date: 2027-07-05T19:46:15.00Z Registrar: NAMECHEAP INC Registrar IANA ID: 1068 Registrar Abuse Contact Email: abuse@namecheap.com Registrar Abuse Contact Phone: +1.6613102107 Reseller: NAMECHEAP INC Domain Status: clientTransferProhibited https://icann.org/epp#clientTransferProhibited Registry Registrant ID:  Registrant Name: Withheld for Privacy Purposes Registrant Organization: Privacy service provided by Withheld for Privacy ehf [...] URL of the ICANN WHOIS Data Problem Reporting System: http://wdprs.internic.net/ >>> Last update of WHOIS database: 2021-08-25T14:58:29.57Z <<< For more information on Whois status codes, please visit https://icann.org/epp`
...
Terminal
           ...
           `user@TryHackMe$ nslookup -type=A tryhackme.com 1.1.1.1 Server:		1.1.1.1 Address:	1.1.1.1#53  Non-authoritative answer: Name:	tryhackme.com Address: 172.67.69.208 Name:	tryhackme.com Address: 104.26.11.229 Name:	tryhackme.com Address: 104.26.10.229`
...
Terminal
           ...
           `user@TryHackMe$ nslookup -type=MX tryhackme.com Server:		127.0.0.53 Address:	127.0.0.53#53  Non-authoritative answer: tryhackme.com	mail exchanger = 5 alt1.aspmx.l.google.com. tryhackme.com	mail exchanger = 1 aspmx.l.google.com. tryhackme.com	mail exchanger = 10 alt4.aspmx.l.google.com. tryhackme.com	mail exchanger = 10 alt3.aspmx.l.google.com. tryhackme.com	mail exchanger = 5 alt2.aspmx.l.google.com.`
...
Terminal
           ...
           `user@TryHackMe$ dig tryhackme.com MX  ; <<>> DiG 9.16.19-RH <<>> tryhackme.com MX ;; global options: +cmd ;; Got answer: ;; ->>HEADER<`
...
| 2    | You happen to meet the IT administrator of the target company at a party. You try to use social engineering to get more information about their systems and network infrastructure. What kind of reconnaissance activity is this? (A for active, P for passive)                                                                   | `A`                                     |
| 3    | When was TryHackMe.com registered?                                                                                                                                                                                                                                                                                                | `20180705`                              |
| 3    | What is the registrar of TryHackMe.com?                                                                                                                                                                                                                                                                                           | `namecheap.com`                         |
| 3    | Which company is TryHackMe.com using for name servers?                                                                                                                                                                                                                                                                            | `cloudflare.com`                        |
| 4    | Check the TXT records of thmlabs.com. What is the flag there?                                                                                                                                                                                                                                                                     | `THM{a5b83929888ed36acb0272971e438d78}` |
| 5    | Lookup tryhackme.com on DNSDumpster. What is one interesting subdomain that you would discover in addition to www and blog?                                                                                                                                                                                                       | `remote`                                |
| 6    | According to Shodan.io, what is the first country in the world in terms of the number of publicly accessible Apache servers?                                                                                                                                                                                                      | `United States`                         |
| 6    | Based on Shodan.io, what is the 3rd most common port used for Apache?                                                                                                                                                                                                                                                             | `8080`                                  |
| 6    | Based on Shodan.io, what is the 3rd most common port used for nginx?                                                                                                                                                                                                                                                              | `888`                                   |
| 7    | Make sure you note all the points discussed in this room, especially the syntax for the command-line tools.                                                                                                                                                                                                                       | `No answer needed`                      |

## 🎓 Key Takeaways
- **[[Passive Reconnaissance]]** gathers info without alerting the target; **[[Active Reconnaissance]]** directly probes systems and can be detected
- **[[WHOIS]]** reveals domain registrar, creation dates, name servers, and sometimes contact info (TCP port 43)
- **[[nslookup]]** and **[[Domain Information Groper (dig)]]** query DNS for A, AAAA, MX, TXT records
- **[[DNSDumpster]]** excels at subdomain discovery beyond what standard DNS queries reveal
- **[[Shodan]]** indexes internet-connected devices — search for your org to find exposed assets
- All these tools are **passive** because they query public databases, not the target directly
